...
![Repozitár JKS](assets/screenshots/repository-jks.png){ width="300" }
![Vyhľadávanie](assets/screenshots/repository-search.png){ width="300" }
</div>
...
<div class="grid" markdown>
![Osobné repozitáre — prázdne](assets/screenshots/repositories-personal-empty.png){ width="300" }
![Vytvorený repozitár](assets/screenshots/repositories-personal.png){ width="300" }
</div>
...
<div class="grid" markdown>
![Nahranie notového záznamu](assets/screenshots/repository-upload.png){ width="300" }
![Výber súboru](assets/screenshots/upload-file-picker.png){ width="300" }
</div>

<div class="grid" markdown>
![Uloženie](assets/screenshots/upload-save.png){ width="300" }
![Nahraté noty](assets/screenshots/repository-my-sheets.png){ width="300" }
</div>
